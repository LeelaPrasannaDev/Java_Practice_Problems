 ...
 public static void main(String[] args) { 
  ...
  if (valid(c)) { 
   ...
   case '*': 
    ...
    System.out.println( 
      "The result of Multiplication " + num2 + " from " + num1 + "=" + multiplyNumbers(num1, num2)); 
    break; 
 
   case '/': 
    System.out.println( 
      "The result of Division " + num2 + " from " + num1 + "=" + divideNumbers(num1, num2)); 
    break; 
 
   case '%': 
    System.out.println( 
      "The result of Modular_Divison " + num2 + " from " + num1 + "=" + findRemainder(num1, num2)); 
    break; 
   default: 
